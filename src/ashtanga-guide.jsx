...
const Fig = ({ d, size = 96, glow = false }) => (
  <svg viewBox="0 0 100 100" width={size} height={size} aria-hidden="true">
    ...
    {d.map((el, i) => {
      const g = glow ? { filter: "drop-shadow(0 0 6px rgba(157,187,170,0.45))" } : undefined;
      const common = { key: i, stroke: C.jade, strokeWidth: 4, strokeLinecap: "round", fill: "none", style: g };
      if (el.c) return <circle key={i} cx={el.c[0]} cy={el.c[1]} r={el.c[2]} fill={C.jade} style={g} />;
...
/* 자세별 피겨 정의 */
const F = {
  samasthiti: [{ c: [50, 16, 7] }, { l: [50, 23, 50, 60] }, { l: [50, 32, 43, 58] }, { l: [50, 32, 57, 58] }, { l: [50, 60, 45, 88] }, { l: [50, 60, 55, 88] }],
  urdhvaHasta: [{ c: [50, 20, 7] }, { l: [50, 27, 50, 62] }, { l: [50, 34, 41, 10] }, { l: [50, 34, 59, 10] }, { l: [50, 62, 45, 88] }, { l: [50, 62, 55, 88] }],
  uttanasana: [{ c: [37, 78, 6] }, { l: [52, 56, 40, 74] }, { l: [52, 56, 48, 88] }, { l: [52, 56, 57, 88] }, { l: [45, 66, 37, 87] }],
  chaturanga: [{ c: [17, 56, 6] }, { l: [24, 60, 72, 62] }, { l: [30, 60, 28, 74] }, { l: [72, 62, 87, 68] }],
  upDog: [{ c: [25, 34, 6] }, { p: "M29 41 Q38 52 58 62" }, { l: [31, 44, 29, 68] }, { l: [58, 62, 86, 68] }],
  downDog: [{ c: [31, 62, 6] }, { l: [21, 82, 51, 38] }, { l: [51, 38, 79, 82] }],
  trikonasana: [{ c: [27, 38, 6] }, { l: [50, 50, 33, 43] }, { l: [50, 50, 28, 87] }, { l: [50, 50, 72, 87] }, { l: [36, 45, 29, 82] }, { l: [36, 45, 44, 13] }],
  parivrttaTrik: [{ c: [27, 38, 6] }, { l: [50, 50, 33, 43] }, { l: [50, 50, 28, 87] }, { l: [50, 50, 72, 87] }, { l: [36, 45, 42, 82] }, { l: [36, 45, 28, 14] }],
  parsvakonasana: [{ c: [26, 34, 6] }, { l: [53, 54, 32, 41] }, { l: [53, 54, 31, 66] }, { l: [31, 66, 31, 88] }, { l: [53, 54, 77, 88] }, { l: [37, 44, 27, 86] }, { l: [37, 44, 13, 22] }],
  prasarita: [{ c: [50, 78, 6] }, { l: [50, 46, 50, 71] }, { l: [50, 46, 25, 88] }, { l: [50, 46, 75, 88] }, { l: [50, 58, 41, 85] }, { l: [50, 58, 59, 85] }],
  parsvottanasana: [{ c: [27, 60, 6] }, { l: [50, 50, 33, 57] }, { l: [50, 50, 37, 88] }, { l: [50, 50, 66, 88] }],
  utthitaHasta: [{ c: [44, 18, 7] }, { l: [44, 25, 44, 62] }, { l: [44, 62, 44, 88] }, { l: [44, 62, 78, 58] }, { l: [44, 34, 76, 56] }, { l: [44, 34, 30, 50] }],
  ardhaBaddhaStand: [{ c: [37, 78, 6] }, { l: [52, 56, 40, 74] }, { l: [52, 56, 50, 88] }, { p: "M52 56 L64 62 L54 68" }, { l: [45, 66, 38, 87] }],
  utkatasana: [{ c: [46, 22, 7] }, { l: [46, 29, 52, 56] }, { l: [47, 34, 37, 11] }, { l: [47, 34, 45, 8] }, { p: "M52 56 L44 72 L46 88" }, { p: "M52 56 L50 74 L52 88" }],
  warrior: [{ c: [48, 20, 7] }, { l: [48, 27, 48, 52] }, { l: [48, 33, 40, 10] }, { l: [48, 33, 56, 10] }, { l: [48, 52, 34, 66] }, { l: [34, 66, 34, 88] }, { l: [48, 52, 70, 88] }],
  warriorB: [{ c: [50, 26, 7] }, { l: [50, 33, 50, 54] }, { l: [50, 38, 22, 38] }, { l: [50, 38, 78, 38] }, { p: "M50 54 L32 66 L32 88" }, { l: [50, 54, 74, 88] }],
  dandasana: [{ c: [40, 38, 7] }, { l: [40, 45, 40, 78] }, { l: [40, 78, 82, 78] }, { l: [40, 58, 45, 80] }],
  paschimottanasana: [{ c: [63, 60, 6] }, { l: [34, 78, 58, 63] }, { l: [34, 78, 81, 76] }, { l: [48, 68, 78, 74] }],
  purvottanasana: [{ c: [28, 42, 6] }, { l: [30, 50, 82, 84] }, { l: [30, 50, 28, 84] }, { l: [56, 67, 66, 88] }],
  januSirsasana: [{ c: [62, 60, 6] }, { l: [36, 78, 57, 63] }, { l: [36, 78, 80, 76] }, { p: "M36 78 L26 68 L22 80" }, { l: [48, 68, 77, 74] }],
  marichyasana: [{ c: [40, 40, 6] }, { l: [40, 47, 39, 78] }, { l: [39, 78, 81, 78] }, { p: "M39 78 L53 56 L57 78" }, { l: [40, 56, 54, 60] }],
  marichyC: [{ c: [40, 42, 6] }, { l: [40, 49, 42, 78] }, { l: [42, 78, 80, 78] }, { p: "M42 78 L52 58 L56 78" }, { l: [40, 54, 58, 62] }, { l: [40, 54, 26, 66] }],
  navasana: [{ c: [33, 40, 6] }, { l: [50, 74, 37, 47] }, { l: [50, 74, 72, 44] }, { l: [43, 58, 64, 52] }],
  bhujapidasana: [{ c: [50, 42, 6] }, { l: [50, 48, 50, 60] }, { l: [42, 54, 42, 84] }, { l: [58, 54, 58, 84] }, { p: "M50 60 L34 56 L30 70" }, { p: "M50 60 L66 56 L70 70" }],
  kurmasana: [{ c: [21, 72, 5] }, { l: [50, 76, 26, 72] }, { l: [50, 76, 82, 66] }, { l: [50, 76, 80, 76] }, { l: [34, 74, 12, 82] }, { l: [34, 74, 16, 62] }],
  garbha: [{ c: [50, 40, 6] }, { p: "M44 46 Q32 60 44 74 Q56 84 64 68" }, { l: [46, 60, 58, 58] }],
  baddhaKonasana: [{ c: [50, 38, 7] }, { l: [50, 45, 50, 72] }, { p: "M50 74 L34 68 L46 82" }, { p: "M50 74 L66 68 L54 82" }],
  upavistha: [{ c: [42, 52, 6] }, { l: [50, 74, 44, 58] }, { l: [50, 74, 18, 84] }, { l: [50, 74, 82, 84] }, { l: [46, 62, 20, 82] }, { l: [46, 62, 80, 82] }],
  suptaPada: [{ c: [15, 79, 5] }, { l: [21, 80, 60, 80] }, { l: [60, 80, 64, 40] }, { l: [34, 78, 62, 44] }],
  setuBandha: [{ c: [28, 82, 5] }, { p: "M30 86 Q50 52 74 86" }],
  utpluthih: [{ c: [50, 34, 6] }, { l: [50, 40, 50, 56] }, { l: [38, 52, 38, 84] }, { l: [62, 52, 62, 84] }, { p: "M38 60 L50 54 L62 60 L50 68 Z" }],
  wheel: [{ p: "M28 84 Q50 34 74 84" }, { c: [33, 76, 5] }, { l: [30, 84, 24, 88] }, { l: [72, 84, 78, 88] }],
  sarvangasana: [{ c: [36, 84, 6] }, { l: [44, 82, 50, 52] }, { l: [50, 52, 52, 16] }, { l: [46, 80, 54, 62] }],
  halasana: [{ c: [36, 82, 6] }, { l: [45, 80, 56, 58] }, { l: [56, 58, 27, 70] }, { l: [27, 70, 25, 76] }],
  matsyasana: [{ c: [24, 76, 5] }, { p: "M28 80 Q40 60 54 78" }, { l: [54, 78, 84, 80] }],
  sirsasana: [{ c: [50, 80, 6] }, { l: [50, 73, 50, 30] }, { l: [50, 30, 46, 10] }, { l: [50, 30, 56, 10] }, { l: [37, 87, 63, 87] }],
  padmasana: [{ c: [50, 36, 7] }, { l: [50, 43, 50, 68] }, { p: "M34 78 L50 68 L66 78 L50 84 Z" }, { l: [50, 52, 38, 72] }, { l: [50, 52, 62, 72] }],
  savasana: [{ c: [19, 78, 6] }, { l: [26, 79, 82, 79] }, { l: [40, 79, 46, 86] }, { l: [60, 79, 68, 85] }],
  pasasana: [{ c: [44, 33, 6] }, { l: [46, 40, 50, 60] }, { p: "M50 60 L42 74 L44 88" }, { p: "M50 60 L48 76 L50 88" }, { l: [46, 46, 62, 56] }, { l: [46, 46, 32, 52] }],
  krounchasana: [{ c: [42, 42, 6] }, { l: [42, 49, 44, 78] }, { p: "M44 78 L34 70 L28 80" }, { l: [44, 78, 62, 36] }, { l: [42, 56, 60, 42] }],
  shalabhasana: [{ c: [17, 68, 5] }, { p: "M22 72 Q50 70 78 60" }, { l: [30, 72, 46, 76] }],
  dhanurasana: [{ c: [21, 60, 5] }, { p: "M26 66 Q50 86 74 62" }, { l: [30, 66, 70, 60] }],
  ustrasana: [{ c: [63, 36, 6] }, { l: [46, 88, 64, 88] }, { l: [46, 88, 46, 66] }, { p: "M46 66 Q56 50 61 42" }, { l: [52, 56, 62, 86] }],
  kapotasana: [{ c: [66, 82, 5] }, { l: [40, 88, 60, 88] }, { l: [40, 88, 38, 64] }, { p: "M38 64 Q52 32 64 78" }, { l: [46, 50, 62, 84] }],
  bakasana: [{ c: [50, 38, 6] }, { l: [50, 44, 50, 56] }, { l: [44, 58, 42, 86] }, { l: [56, 58, 58, 86] }, { p: "M50 56 L40 60 L44 70" }, { p: "M50 56 L60 60 L56 70" }],
  ekaPadaSirsa: [{ c: [46, 44, 6] }, { l: [46, 52, 46, 78] }, { l: [46, 78, 82, 78] }, { p: "M46 78 Q26 42 56 36" }, { l: [42, 60, 52, 60] }],
  yoganidra: [{ c: [26, 78, 5] }, { l: [32, 80, 64, 80] }, { p: "M60 78 Q72 48 38 64" }, { p: "M58 80 Q74 56 42 70" }],
  tittibhasana: [{ c: [50, 44, 6] }, { l: [50, 50, 50, 62] }, { l: [46, 56, 44, 84] }, { l: [56, 56, 58, 84] }, { l: [48, 58, 16, 50] }, { l: [54, 58, 86, 50] }],
  pincha: [{ c: [40, 76, 5] }, { l: [32, 86, 52, 86] }, { l: [44, 86, 47, 64] }, { l: [47, 64, 50, 30] }, { l: [50, 30, 45, 10] }, { l: [50, 30, 57, 12] }],
  mayurasana: [{ c: [17, 53, 5] }, { l: [23, 57, 80, 58] }, { l: [46, 58, 45, 84] }],
  gomukhasana: [{ c: [48, 40, 6] }, { l: [48, 47, 48, 78] }, { p: "M48 80 L34 74 L44 85" }, { p: "M48 80 L62 74 L52 85" }, { l: [48, 54, 56, 44] }, { l: [48, 68, 55, 57] }],
  vasistha: [{ c: [74, 38, 6] }, { l: [26, 84, 70, 44] }, { l: [40, 71, 34, 86] }, { l: [52, 60, 60, 34] }],
  koundinya: [{ c: [48, 44, 6] }, { l: [48, 50, 50, 58] }, { l: [44, 60, 42, 86] }, { l: [54, 60, 56, 86] }, { l: [50, 56, 84, 48] }, { l: [50, 58, 82, 60] }],
  astavakra: [{ c: [48, 44, 6] }, { l: [48, 50, 50, 58] }, { l: [44, 60, 42, 86] }, { l: [54, 60, 56, 86] }, { l: [50, 54, 80, 60] }, { l: [50, 56, 78, 68] }],
  viparitaDanda: [{ c: [30, 80, 5] }, { l: [24, 86, 42, 86] }, { p: "M38 86 Q46 42 78 84" }, { l: [62, 62, 80, 84] }],
  hanumanasana: [{ c: [50, 34, 7] }, { l: [50, 41, 50, 74] }, { l: [50, 74, 16, 84] }, { l: [50, 74, 84, 84] }, { l: [50, 48, 42, 24] }, { l: [50, 48, 58, 24] }],
  natarajasana: [{ c: [46, 22, 7] }, { l: [46, 29, 48, 60] }, { l: [48, 60, 48, 88] }, { p: "M48 60 Q66 68 70 40" }, { p: "M46 36 Q60 44 70 40" }, { l: [46, 36, 28, 28] }],
  rajaKapota: [{ c: [48, 46, 6] }, { p: "M40 84 L28 78 L20 86" }, { p: "M40 84 Q64 82 70 56" }, { l: [42, 84, 46, 54] }, { p: "M46 56 Q62 42 70 56" }],
};
